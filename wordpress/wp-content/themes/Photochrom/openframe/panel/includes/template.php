...
function op_panel_tab_open( $tab_name = null ) {
	?>
	<div class="op-panel-section" data-tab="<?php esc_attr_e( $tab_name ); ?>">	
	<?php
}
...
function op_panel_opt_picker( $option_name ) {
	?>
	<span class="op-panel-picker-pal"></span>
	<input type="text" name="<?php esc_attr_e( $option_name ) ?>" class="op-panel-picker regular-text code" value="<?php esc_attr_e( op_theme_opt( $option_name ) ); ?>" />
	<?php
}
